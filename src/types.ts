...
//* 字段选项
export interface FieldOption<T extends DbType = DbType> {
  default?: DbType | (() => DbType)
  type: DbType
  get?: (vaue: T, row: Record<string, DbType>) => Promise<any> | any
  set?: (value: any) => Promise<T> | T
}

export interface FieldOptionType2 {
  get?: () => Promise<any> | any
...
//* 字段选项集合
export type FieldOptionSet = Record<string, FieldOption>
